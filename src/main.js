...
import ContentArticle from "@/components/content-article/fs-content-article.vue";
import ContentHeader from "@/components/content-header/fs-content.header.vue"
...
const routes = [
  ...
  { path: '/blog/:slug', component: Content },
...
app.component("content-article", ContentArticle);
